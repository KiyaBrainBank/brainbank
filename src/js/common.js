...
$('body').on( 'click', 'div.language-bar div.language-list ul.lst-languages>li.list-nh a ', function ( e ) {
    ...
    //  $('ul.dropdown-sub').show();
     if ($(this).hasClass('language-selected')){
        $(this).next('ul.dropdown-sub').addClass('active-dp');
     }else{
       $(this).next('ul.dropdown-sub').removeClass('active-dp');
     }
     myfunction2 (); 
});
...
function dateFilter(){
  $('body').on('click', 'a.calender-btn', function (e) {
    console.log('working!');
...
function listFilter(){
  $('body').on('click', 'a.filter-btn', function (e) {
    $(this).parents('ul.filter-list-info').find('.slidefilter-container').removeClass('slide-showing');
    e.stopPropagation();
  console.log('working!');
      e.stopPropagation();
